    ...
    public function run(): void
    {
        ...
        $modules = [
            ...
            [
                ...
                'display_name_ar' => 'تحليلات المتاجر',
                'description' => 'Detect suspicious behavior and prevent losses in retail environments',
                'description_ar' => 'كشف السلوك المشبوه ومنع الخسائر في بيئات البيع بالتجزئة',
                'is_active' => true,
                'icon' => 'shopping-bag',
                'min_fps' => 25,
                'min_resolution' => '1080p',
                ...
                'config_schema' => [
                    'confidence_threshold' => ['type' => 'number', 'min' => 0.5, 'max' => 1.0, 'default' => 0.75],
                    'risk_threshold' => ['type' => 'number', 'min' => 1, 'max' => 100, 'default' => 50],
            ...
            [
                ...
                'display_name_ar' => 'تتبع الحضور',
                'description' => 'Automatic attendance tracking using face recognition',
                'description_ar' => 'تتبع الحضور التلقائي باستخدام التعرف على الوجوه',
                'is_active' => true,
                'icon' => 'user-check',
                'min_fps' => 25,
                'min_resolution' => '1080p',
                ...
                'config_schema' => [
                    'confidence_threshold' => ['type' => 'number', 'min' => 0.5, 'max' => 1.0, 'default' => 0.85],
                    'check_in_start' => ['type' => 'time', 'default' => '08:00'],
                    'check_in_end' => ['type' => 'time', 'default' => '10:00'],
                    'check_out_start' => ['type' => 'time', 'default' => '17:00'],
                    'check_out_end' => ['type' => 'time', 'default' => '19:00'],
                ],
                'default_config' => [
                    'confidence_threshold' => 0.85,
            ...
            [
                'name' => 'worker_safety',
                'display_name' => 'Worker Safety',
                'display_name_ar' => 'سلامة العمال',
                'description' => 'Monitor PPE compliance and worker safety in industrial environments',
                'description_ar' => 'مراقبة الالتزام بمعدات الحماية الشخصية وسلامة العمال في البيئات الصناعية',
                'is_active' => true,
                'icon' => 'hard-hat',
                'min_fps' => 15,
                'min_resolution' => '720p',
                'display_order' => 13,
                'config_schema' => [
                    'confidence_threshold' => ['type' => 'number', 'min' => 0.5, 'max' => 1.0, 'default' => 0.80],
                    'require_helmet' => ['type' => 'boolean', 'default' => true],
                    'require_vest' => ['type' => 'boolean', 'default' => true],
                    'require_gloves' => ['type' => 'boolean', 'default' => false],
                ],
                'default_config' => [
            ...
            [
                ...
                'display_name_ar' => 'مراقبة الإنتاج',
                'description' => 'Monitor production lines and detect defects and anomalies',
                'description_ar' => 'مراقبة خطوط الإنتاج واكتشاف العيوب والحالات الشاذة',
                'is_active' => true,
                'icon' => 'factory',
                'min_fps' => 25,
                'min_resolution' => '1080p',
                ...
                'config_schema' => [
                    'confidence_threshold' => ['type' => 'number', 'min' => 0.5, 'max' => 1.0, 'default' => 0.85],
                    'defect_detection' => ['type' => 'boolean', 'default' => true],
                    'count_products' => ['type' => 'boolean', 'default' => true],
                ],
                'default_config' => [
                    'confidence_threshold' => 0.85,
