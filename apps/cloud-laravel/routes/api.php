...
Route::prefix('v1')->group(function () {
    ...
    Route::post('/auth/login', [AuthController::class, 'login'])->middleware(['throttle:10,1', 'clear.login.rate.limit']); // 10 attempts per minute - cleared on success
    ...
    // Heartbeat endpoint: public for initial registration, requires HMAC after registration
