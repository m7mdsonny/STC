...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    'landing.hero.subtitle': 'حول كاميرات المراقبة إلى عيون ذكية تحمي منشآتك',
    'landing.hero.cta': 'ابدأ تجربتك المجانية',
    'landing.features': 'المميزات',
    'landing.modules': 'الموديولات',
    'landing.pricing': 'الباقات',
    'landing.contact': 'تواصل معنا',
    'landing.freeTrial': 'تجربة مجانية 14 يوم',
  },
  ...
  en: {
    ...
    'landing.hero.subtitle': 'Transform your surveillance cameras into intelligent eyes',
    'landing.hero.cta': 'Start Free Trial',
    'landing.features': 'Features',
    'landing.modules': 'Modules',
    'landing.pricing': 'Pricing',
    'landing.contact': 'Contact Us',
    'landing.freeTrial': '14-Day Free Trial',
  },
};
